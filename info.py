...
USERNAME = environ.get('USERNAME', "https://t.me/As_any_Movie_1") # ADMIN USERNAME
...
DATABASE_NAME = environ.get('DATABASE_NAME', "rckannada")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'KF_files')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002237896833') # If anyone sends a request message to your bot, you will get it in this channel.
...
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/KFCINEMAS/129")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/KFCINEMAS")
...
SHORTENER_API2 = environ.get("SHORTENER_API2", "bbfd74f4c9fbf58551fdc20190b0dada42e2ad9d")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'yamlinks.com')
SHORTENER_API3 = environ.get("SHORTENER_API3", "bbfd74f4c9fbf58551fdc20190b0dada42e2ad9d")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://envs.sh/v_h.jpg https://envs.sh/v_E.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://envs.sh/vZW.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/vZI.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
